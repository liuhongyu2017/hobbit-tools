 ...
 */
@ConfigurationProperties("hobbit")
public class HobbitProperties implements EnvironmentAware, EnvironmentCapable {

  @Nullable
  private Environment environment;

  /**
   * 装载自定义配置hobbit.prop.xxx
   */
  @Getter
  ...
  public String getName() {
    ...
    return environment.getProperty("spring.application.name",
        environment.getProperty("hobbit.name", ""));
  }
