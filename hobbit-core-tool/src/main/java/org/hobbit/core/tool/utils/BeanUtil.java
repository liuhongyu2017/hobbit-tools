...
import org.hobbit.core.tool.beans.BeanProperty;
import org.hobbit.core.tool.beans.HobbitBeanCopier;
import org.hobbit.core.tool.convert.HobbitConverter;
...
public class BeanUtil extends BeanUtils {
  ...
  public static <T> T copy(@Nullable Object source, Class<?> sourceClazz, Class<T> targetClazz) {
    ...
    HobbitBeanCopier copier = HobbitBeanCopier.create(sourceClazz, targetClazz, false);
  ...
  public static void copy(@Nullable Object source, @Nullable Object targetBean) {
    ...
    HobbitBeanCopier copier =
        HobbitBeanCopier.create(source.getClass(), targetBean.getClass(), false);
  ...
  public static void copyNonNull(@Nullable Object source, @Nullable Object targetBean) {
    ...
    HobbitBeanCopier copier =
        HobbitBeanCopier.create(source.getClass(), targetBean.getClass(), false, true);
  ...
  public static <T> T copyWithConvert(@Nullable Object source, Class<?> sourceClazz,
    ...
    HobbitBeanCopier copier = HobbitBeanCopier.create(sourceClazz, targetClazz, true);
    T to = newInstance(targetClazz);
    copier.copy(source, to, new HobbitConverter(sourceClazz, targetClazz));
    return to;
  }
   ...
   * <p>
   * Note: The source and target classes do not have to match or even be derived from each other, as
   * long as the properties match. Any bean properties that the source bean exposes but the target
