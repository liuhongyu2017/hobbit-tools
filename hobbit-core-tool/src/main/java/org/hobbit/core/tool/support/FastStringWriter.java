...
public class FastStringWriter extends Writer {
   ...
   * character sequence <tt>csq</tt>, the entire sequence may not be appended. For instance,
   * invoking the <tt>toString</tt> method of a character buffer will return a subsequence whose
